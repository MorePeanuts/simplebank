...
import (
	...
	"github.com/MorePeanuts/simplebank/gapi"
	"github.com/MorePeanuts/simplebank/pb"
	"github.com/MorePeanuts/simplebank/util"
	"github.com/MorePeanuts/simplebank/worker"
...
func main() {
	...
	if err != nil {
		log.Fatal().Err(err).Msg("connot connect to db")
	}
...
func runGinServer(config util.Config, store db.Store) {
	...
	if err != nil {
		log.Fatal().Err(err).Msg("cannot init server")
	}
